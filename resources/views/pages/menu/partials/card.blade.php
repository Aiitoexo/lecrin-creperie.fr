<div class="h-96 w-full sm:col-span-6 lg:col-span-4 2xl:col-span-4 1xl:col-span-4 col-span-12 relative">
...
<div class="h-screen w-screen fixed top-0 left-0 z-50 flex justify-center items-center">
    <div class="h-96 bg-white w-4/12"></div>
</div>

sinon menu classic
--}}
            @if ($active_extras->active_extras === true)
                <div class="h-1/5 w-full flex justify-end items-center px-8">
                    @if (session('type_command'))
                        <button class="flex justify-center items-center button_modal_items">
            ...
            @else
                <form class="h-1/5 grid grid-cols-12" action="{{ route('add.item') }}" method="post">
                    @csrf
...
<div class="modal_items hidden fixed top-0 left-0 z-50 h-screen w-screen flex justify-center items-center">
    <div class="w-3/12 bg-white overflow-hidden rounded-7xl border-8 border-gray-800">
        <img class="w-full h-44 object-center object-cover" src="{{ $item->img }}" alt="{{ $item->alt_img }}">
        <div class="bg-white border-t-4 border-gray-800 py-4 px-8 ">
{{--            TODO : Card Supplement a finir--}}
        </div>
    </div>
</div>
